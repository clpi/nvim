...
M.wiki_pages = function(opts)
  ...
  local wiki_cmd = 'vimwiki#base#find_files(' .. index .. ', 0)'
  pickers.new(opts, {
    prompt_title = "wiki",
    finder = finders.new_table {
      results = vim.api.nvim_eval(wiki_cmd)
    },
...
M.wiki_link = function(opts)
  ...
  local wiki_path = vim.api.nvim_eval('vimwiki#vars#get_wikilocal("path")')
