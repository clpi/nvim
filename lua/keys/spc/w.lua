-- mk CONFIG Local Leader KEYMAPS (,w) --
local d = require("user.util").dirs
local e = require("user.util").edit
local req = require "user.util".mods

local path = "~/mk"
-- return {
lvim.builtin.which_key.mappings.w = { name = "+miki",
  ["v"] = e(d.plug, "vimwiki.lua"),
  ["z"] = { "<CMD>e ~/.config/lvim/lua/user/plug/zk.lua", "configure zk"},
  ...
  ["."] = { "<CMD>VImwikiDiaryNextDay<CR>", "next note"},
  [","] = { "<CMD>VimwikiDiaryPrevDay<CR>", "prev note"},

  ["<"] = { "<CMD>VimwikiMakeYesterdayDiaryNote<CR>", "yesterday note"},
  [">"] = { "<CMD>VimwikiMakeTomorrowDiaryNote<CR>", "tmrw note"},

  ["/"] = { ":e ~/mk/index.md<CR><ESC>:Telescope find_files<CR>", "find_files" },
  [";"] = { ":e ~/mk/index.md<CR><ESC>:Telescope live_grep<CR>", "live_grep" },
  ["?"] = { ":e ~/mk/index.md<CR><ESC>:Telescope fd<CR>", "fd" },
  ...
  d = { name = "+diary",
    ...
    t = { ":e ~/mk/templates/vimmk/diary_entry.md<CR>", "diary template" },
  ...
  t = { name = "+templates",
    ...
    v           = { ":e ~/mk/templats/vimmk/index.md<CR>", "vimmk" },
